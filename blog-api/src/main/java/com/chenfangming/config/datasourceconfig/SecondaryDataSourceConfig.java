 ...
 */
@Configuration
@MapperScan(basePackages = "com.chenfangming.persistence.dao.secondary", sqlSessionTemplateRef = "secondarySqlSessionTemplate")
public class SecondaryDataSourceConfig {
    ...
    public MapperScannerConfigurer mapperScannerConfig() {
        ...
        mapperScannerConfig.setBasePackage("com.chenfangming.persistence.dao.secondary");
